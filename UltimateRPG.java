...
// class player turunan dari character
class Player extends Character {
    ...
    int potions;
    Weapon weapon;
// membuat beberapa setting player
...
// method untuk serangan player kepada enemy
...
// method untuk loot seperti gold,potion,dan weapon
...
// menampilkan informasi status player
...
// untuk memberikan senjata secara acak 
...
// class enemy atau musuh turunan dari class character
...
// method serangan khusus dari musuh
    void specialAttack(Character target) {
        if (target instanceof Player) {
...
// pengulangan untuk kondisional dalam permainan
...
// untuk memberikan musuh secara random atau acak 
